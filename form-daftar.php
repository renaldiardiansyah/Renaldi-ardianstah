...
<div class="mb-3">
    <label for="agama" class="form-label">Agama: </label>
          ...
          <div class="mb-3">
              <label for="sekolah_asal" class="form-label">Desa/Kelurahan: </label>
              <input type="text" class ="form-control" name="desa" placeholder="Desa/Kelurahan" />
          </div>
          <div class="mb-3">
              <label for="sekolah_asal" class="form-label">Kecamatan: </label>
          ...
          <div class="mb-3">
              <label for="provinsi" class="form-label">Provinsi: </label>
                      <select name="provinsi" class="form-control">
                          ...
                          <option>Jawa Tengahs</option>
                      </select>
          </div>
          <div class="mb-3">
            <label for="sekolah_asal" class="form-label">Kode Pos </label>
            <input type="text" class ="form-control" name="kode_pos" placeholder="Kecamatan" />
          </div>
          <div class="mb-3">
